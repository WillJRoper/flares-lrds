...
for spectra in args.spectra:
    ...
    for snap in all_sfr_100.keys():
        all_sfr_100[snap][all_sfr_100[snap] == 0] = 1
        all_sfr_10[snap][all_sfr_10[snap] == 0] = 1
    ...
    for snap in all_sfr_100.keys():
        ...
        sfr_100_lrd = all_sfr_100[snap][masks[snap]]
        sfr_10_lrd = all_sfr_10[snap][masks[snap]]
        ...
        ax1.set_ylabel(r"$\mathrm{SFR}_{100} \, [\mathrm{yr}^{-1}]$")
        ...
        ax2.set_ylabel(r"$\mathrm{SFR}_{10} \, [\mathrm{yr}^{-1}]$")
        ax2.legend()
        ...
        # Save the figure
        savefig(fig, f"{spectra}/{snap}/sfr_vs_stellar_mass_{snap}.png")
