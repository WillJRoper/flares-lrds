...
if __name__ == "__main__":
    ...
    survey = Survey(
        ...
        emission_model=get_emission_model(fesc=0.0, fesc_ly_alpha=1.0),
    ...
    survey.get_images_luminosity(fov=60 * kpc, kernel=kernel_data)
    survey.get_images_fluxes(fov=60 * kpc, kernel=kernel_data)
